    ...
    <main className={styles.main}>
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.lastUpdated}>最終更新：2024年3月1日</p>
        </div>
        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.text}>本規約において、以下の用語の意味は次の通りとします。</p>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第4条（契約の成立）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第5条（料金および支払方法）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第6条（お客様の協力義務）</h2>
            <p className={styles.text}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第7条（知的財産権）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第8条（禁止事項）</h2>
            <p className={styles.text}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第9条（保証の範囲）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第10条（免責事項）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第11条（秘密保持）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第12条（契約の解除）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第13条（規約の変更）</h2>
            <p className={styles.text}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第14条（準拠法および管轄裁判所）</h2>
            <ol className={styles.orderedList}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>第15条（協議事項）</h2>
            <p className={styles.text}>
